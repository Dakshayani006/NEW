...
public class NetsuiteUpdParentCustEnvelope {

    /*@XmlElement(required = true,name="Header")
    protected Header header;*/
    @XmlElement(required = true,name="Body")
    protected NetsuiteUpdParentCustSoapBody body;
	...
	public NetsuiteUpdParentCustSoapBody getBody() {
		return body;
	}
	public void setBody(NetsuiteUpdParentCustSoapBody body) {
		this.body = body;
	}
}
